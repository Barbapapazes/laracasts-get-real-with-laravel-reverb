...
<div
                ...
                <div>
                    <div class="flex items-center gap-x-2">
                        <span
                            ...
                            x-text="message.user.name"></span>

                        <time
                            class="text-sm text-gray-600"
                            x-text="message.sent_at"></time>
                    </div>
    ...
    <div
        ...
        @else
        <div class="flex flex-grow flex-col items-center justify-center gap-y-4 rounded-md border bg-gray-100 p-6">
