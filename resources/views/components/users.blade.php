                ...
                <span class="relative">
                    ...
                    <span class="absolute -bottom-1 -right-1">
                        <span
                            ...
                            <span
                                class="flex h-2 w-2 rounded-full border " :class="{ 'bg-green-600 border-green-600': user.online, 'bg-sidebar border-gray-400': !user.online }"></span>
                        </span>
                    </span>
                </span>
